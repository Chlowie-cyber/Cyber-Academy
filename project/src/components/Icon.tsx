...
export function Icon({ name, className = 'w-6 h-6' }: IconProps) {
  const icons: Record<string, JSX.Element> = {
    ...
    bug: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="m8 2 1.88 1.88M14.12 3.88 16 2M9 7.13v-1.5a3.5 3.5 0 0 1 6 0v1.5M12 20c-3.3 0-6-2.7-6-6v-3a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v3c0 3.3-2.7 6-6 6M6 13H4m2 4H4m16-4h-2m2 4h-2M12 8v12" />
      </svg>
    ),
    terminal: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    siren: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M5 21a2 2 0 0 0 2-2v-1h10v1a2 2 0 0 0 2 2H5zM12 3v2M12 7h.01M21 12h-2M5 12H3M18.4 5.6 17 7M7 7 5.6 5.6" />
      </svg>
    ),
    rocket: (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
